...
const getPlayBookFromId = async (contractId) => {
  ...
  let updatePlaybook = obj;
  if (obj["status"]==="REVIEW") updatePlaybook=await runtimeSummaryCreation(obj);
...
const qualityProvided = async (parameters,playBookId,surveyCode,sectionCode) => {
  ...
  if ((serviceTypeDetailsId !=-1) && (serviceLevelAgreementId !=-1) && (facilityServiceConditionId !=-1)) {
    //let query="SELECT \"PB_Services\".\"serviceName\", \"PB_ServiceLevelAgreements\".\"serviceLevelAgreementName\",\"PB_ServiceKPIs\".\"kpiName\",\"PB_Frequencies\".\"frequency\", \"PB_ServiceSlaKPIs\".\"value\" FROM \"PB_ServiceKPIs\",\"PB_ServiceLevelAgreements\",\"PB_Services\", \"PB_ServiceSlaKPIs\",\"PB_Frequencies\" WHERE \"PB_Services\".\"id\" = \"PB_ServiceSlaKPIs\".\"idService\" and \"PB_ServiceLevelAgreements\".\"id\" = \"PB_ServiceSlaKPIs\".\"idSLA\" and \"PB_ServiceKPIs\".\"id\" =  \"PB_ServiceSlaKPIs\".\"idKPI\" and \"PB_Frequencies\".\"id\" = \"PB_ServiceSlaKPIs\".\"idFrequency\"";    
    let query="SELECT \"PB_Services\".\"serviceName\",\"PB_ServiceLevelAgreements\".\"serviceLevelAgreementName\",\"PB_ServiceKPIs\".\"kpiName\",\"PB_ServiceKPIs\".\"calculateProcedure\",\"PB_Frequencies\".\"frequency\",\"PB_ServiceSlaKPIs\".\"value\",\"PB_ConditionIndices\".\"levelTypeName\",\"PB_ServiceKPIMeasureProcedures\".\"measureProcedureDescription\",\"PB_ServiceKPIMeasureMethods\".\"measureMethodDescription\" FROM \"PB_ServiceKPIs\",\"PB_ServiceLevelAgreements\",\"PB_Services\", \"PB_ServiceSlaKPIs\",\"PB_Frequencies\",\"PB_ConditionIndices\",\"PB_ServiceKPIMeasureProcedures\",\"PB_ServiceKPIMeasureMethods\" WHERE	\"PB_ServiceSlaKPIs\".\"idService\" = \"PB_Services\".\"id\" and	\"PB_ServiceSlaKPIs\".\"idSLA\" = \"PB_ServiceLevelAgreements\".\"id\" and \"PB_ServiceSlaKPIs\".\"idCondition\" = \"PB_ConditionIndices\".\"id\" and	\"PB_ServiceSlaKPIs\".\"idKPI\" = \"PB_ServiceKPIs\".\"id\" and 	\"PB_ServiceSlaKPIs\".\"idFrequency\"= \"PB_Frequencies\".\"id\" and 	\"PB_ServiceKPIs\".\"idMeasuringProcedures\" = \"PB_ServiceKPIMeasureProcedures\".\"id\" and	\"PB_ServiceKPIs\".\"idMeasuringMethod\" = \"PB_ServiceKPIMeasureMethods\".\"id\" and	\"PB_ConditionIndices\".\"id\" = " + facilityServiceConditionId + " and 	\"PB_Services\".\"id\" = " + serviceTypeDetailsId + " and 	\"PB_ServiceLevelAgreements\".\"id\" = " + serviceLevelAgreementId + " ORDER BY  \"PB_ServiceSlaKPIs\".\"idKPI\";"
    let results = await models.sequelize.query(query);
    ...
    for (r in info) {
      //if ((info[r].kpiName==="B.1 Cold satisfaction") && (info[r].serviceLevelAgreementName===serviceLevelAgreement.value)) {
        row=[await generateDynamicQuestionTemplate("kpPI" +r,info[r].kpiName,playBookId,sectionCode),"Yes",await generateDynamicQuestionTemplate("kpMP" +r,info[r].measureProcedureDescription,playBookId,sectionCode),await generateDynamicQuestionTemplate("kpMD" +r,info[r].measureMethodDescription,playBookId,sectionCode),await generateDynamicQuestionTemplate("kpCP" +r,info[r].calculateProcedure,playBookId,sectionCode),await generateDynamicQuestionTemplate("kpFR" +r,info[r].frequency,playBookId,sectionCode),await generateDynamicQuestionTemplate("kpSL" +r,info[r].value,playBookId,sectionCode)];
        rows.push(row);
...
const penaltiesRelatedMonitoringSystem = async (parameters,playBookId,surveyCode,sectionCode) => {
  ...
  if ((serviceLevelAgreementId !=-1) && (serviceTypeDetailsId !=-1) && (facilityServiceConditionId !=-1)) {
    ...
    //let query= "SELECT	\"PB_ServiceKPIs\".\"kpiName\",\"PB_ServiceSlaKPIs\".\"value\",\"PB_ServiceSlaPenalties\".\"value\" as penalty FROM public.\"PB_ServiceSlaKPIs\",\"PB_ServiceSlaPenalties\",\"PB_ServiceKPIs\" where \"PB_ServiceSlaPenalties\".\"idKPI\" = \"PB_ServiceSlaKPIs\".\"idKPI\" and    \"PB_ServiceSlaPenalties\".\"idKPI\" = \"PB_ServiceKPIs\".\"id\" and	\"PB_ServiceSlaPenalties\".\"idService\" = " + serviceTypeDetailsId + " and 	\"PB_ServiceSlaPenalties\".\"idSLA\" = " + serviceLevelAgreementId + " and \"PB_ServiceSlaKPIs\".\"idCondition\" = " + facilityServiceConditionId + " and \"PB_ServiceSlaPenalties\".\"idKPI\" != 0;";
    let query = "select \"PB_ServiceKPIs\".\"kpiName\",\"PB_ServiceSlaKPIs\".\"value\",\"PB_ServiceSlaPenalties\".\"value\" as penalty from \"PB_ServiceSlaPenalties\",\"PB_ServiceSlaKPIs\",\"PB_ServiceKPIs\" where \"PB_ServiceKPIs\".\"id\" = \"PB_ServiceSlaPenalties\".\"idKPI\" and	\"PB_ServiceSlaKPIs\".\"idKPI\" = \"PB_ServiceSlaPenalties\".\"idKPI\" and	\"PB_ServiceSlaKPIs\".\"idSLA\" = \"PB_ServiceSlaPenalties\".\"idSLA\" and	\"PB_ServiceSlaKPIs\".\"idService\" = \"PB_ServiceSlaPenalties\".\"idService\" and	\"PB_ServiceSlaPenalties\".\"idKPI\" != 0 and	\"PB_ServiceSlaPenalties\".\"idSLA\" = " + serviceLevelAgreementId + " and \"PB_ServiceSlaPenalties\".\"idService\" = " + serviceTypeDetailsId + " and  \"PB_ServiceSlaKPIs\".\"idCondition\" = " + facilityServiceConditionId + ";";
    let results = await models.sequelize.query(query);
    ...
    for (serviceType=0;serviceType<serviceTypeDetailsTable.length;serviceType++) {
      if ((serviceType % 2)==0) {
        ...
        if (a.name==="# of elements") {
          row=[parameters.value,a.tooltip,a,b];
        } else {
          row=[parameters.value,a.code,a,b];
        }
        rows.push(row);
      }
    }        
